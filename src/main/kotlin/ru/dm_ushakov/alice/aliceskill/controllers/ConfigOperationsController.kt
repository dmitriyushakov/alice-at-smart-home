...
class ConfigOperationsController(
    ...
    @RequestMapping(method = [GET], path = ["/{userId}/{deviceId}"])
    ...
    @RequestMapping(method = [POST, PUT], path = ["/{userId}/{deviceId}"])
    ...
    @RequestMapping(method = [DELETE], path = ["/{userId}/{deviceId}"])
    ...
    @RequestMapping(method = [GET], path = ["/{userId}/{deviceId}/cap/{capType}"])
    ...
    @RequestMapping(method = [POST, PUT], path = ["/{userId}/{deviceId}/cap"])
    ...
    @RequestMapping(method = [DELETE], path = ["/{userId}/{deviceId}/cap/{capType}"])
    ...
    @RequestMapping(method = [GET], path = ["/{userId}/{deviceId}/prop/{propType}"])
    ...
    @RequestMapping(method = [POST, PUT], path = ["/{userId}/{deviceId}/prop"])
    ...
    @RequestMapping(method = [DELETE], path = ["/{userId}/{deviceId}/prop/{propType}"])

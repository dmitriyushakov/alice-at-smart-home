...
class BasicFloatPropertyStateMapping(
    ...
    override fun convertTo(state: FloatPropertyState, capability: FloatProperty): String {
    ...
    override fun convertTo(stateString: String, capability: FloatProperty): FloatPropertyState {

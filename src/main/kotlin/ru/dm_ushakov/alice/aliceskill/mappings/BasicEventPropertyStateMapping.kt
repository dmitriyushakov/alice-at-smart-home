...
class BasicEventPropertyStateMapping: StateMapping<EventPropertyState, EventPropertyState> {
    override fun convertFromState(state: EventPropertyState, capability: EventPropertyState): String {
        return state.value.eventTypeName
    }

    override fun convertToState(stateString: String, capability: EventPropertyState): EventPropertyState {
